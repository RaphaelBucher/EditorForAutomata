...
public class ErrorMessage {
	...
	/** Simulates the fade effect. The first half of the message duration, full red Color is shown.
	During the second half, the message fades away by reducing the alpha from 255 to 0. */
	private static int getFadeAlpha() {
		// For e.g. ERROR_MESSAGE_DURATION_MILLIS = 3000, goes down from 3000 to 0 (negative 
		...
		// fade effect starts at halftime. So for e.g. ERROR_MESSAGE_DURATION_MILLIS = 3000,
