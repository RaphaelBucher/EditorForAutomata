...
public class DrawablePanel extends JPanel {
	...
	private void initCursors() {
		...
		// The second parameter of createCustomCursor is the cursors hotspot. This specifies where in
		// the image the actual cursor potition is. (1, 1) would be top left, (25, 25) in the middle.
	...
	private void updateCursor(ToolBar toolBar) {
		if (toolBar.getAddStateButton().isSelected()) {
			...
			// only start state is selected. Other combos are excluded at handleStateButtons of class
			// ToolBar.
