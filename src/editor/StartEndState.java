...
public class StartEndState extends State {
	...
	public void paint(Graphics2D graphics2D) {
		...
		graphics2D.drawOval(drawX - (Config.END_STATE_INNER_DIAMETER / 2), 
				drawY - (Config.END_STATE_INNER_DIAMETER / 2),
				Config.END_STATE_INNER_DIAMETER, Config.END_STATE_INNER_DIAMETER);
		
		// the arrow indicating that it's a start state
		graphics2D.drawArc(drawX - Config.STATE_DIAMETER, drawY - Config.STATE_DIAMETER, 
				Config.STATE_DIAMETER, Config.STATE_DIAMETER, 225, 45);
	}
}
